...
function StudentDetailPage() {
  ...
  function handleReject() {
    ...
    alert(`Dossier de ${student.name} rejeté : ${reason}`);
          ...
          <Card className="rounded-3xl border-0 shadow-sm">
            ...
            <CardContent className="space-y-4">
              <p className="text-sm text-slate-500">
                Vérifie que la carte étudiante est valide, lisible et correspond
                aux informations renseignées.
              </p>
              ...
              <div className="flex flex-col gap-3">
                <Button className="w-full rounded-2xl text-black-700" onClick={handleValidate}>
                  ✓ Valider le dossier
                </Button>
                <Button
                  variant="destructive"
