        ...
        <Card className="rounded-3xl border-0 shadow-sm">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-3">
              {props.merchants.map(function (merchant) {
                return (
          ...
          <Card className="rounded-3xl border-0 shadow-sm">
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                <div>
                  <p className="mb-3 text-sm font-semibold text-slate-700">Derniers avis</p>
                  <div className="space-y-3">
                    <div className="rounded-2xl bg-slate-50 p-4">
                      ...
                      <p className="mt-2 text-sm text-slate-600">Très bon accueil et réduction appliquée.</p>
                    </div>
                    <div className="rounded-2xl bg-slate-50 p-4">
                      <div className="flex items-center justify-between gap-3">
                      ...
                      <p className="mt-2 text-sm text-slate-600">Service rapide le midi.</p>
                    </div>
                  </div>
                </div>
              </div>
